	...
	<div class="section">
		<div class="tile is-ancestor">
			...
			<div class="tile is-8 is-vertical is-parent">
				<div class="tile is-child box">
					<p class="title"><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo date("F jS Y");?></p>
					<hr/>

					<p class="is-size-1 has-text-centered has-text-weight-bold" style="padding-top: 50px;"><?php echo date("l"); ?></p>
				</div>
	...
	<div class="section">
		<div class="tile is-ancestor">
			...
			<div class="tile is-3 is-parent is-vertical">
				<div class="tile is-child box">					
					<p class="title"><i class="fa fa-users" aria-hidden="true"></i> Customers</p>

					<hr/>

					<p class="is-size-1 has-text-centered has-text-info"><?php  ?></p>
				</div>

				<div class="tile is-child box">					
					<p class="title"><i class="fa fa-money" aria-hidden="true"></i> Gross Pay</p>

					<hr/>

					<p class="is-size-1 has-text-centered has-text-success"><i class="fa fa-usd"></i><?php if(isset($gross)){ echo $gross; }?></p>
				</div>
			</div>
			
			<div class="tile is-vertical is-parent">
				<div class="tile is-child box">
					<p class="title"><i class="fa fa-clock-o" aria-hidden="true"></i> Latest</p>
					<hr/>
					<?php
